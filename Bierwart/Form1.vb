...
Public Class Form1
    ...
    Dim Forderungsrechnung(1000, 11) As String
    Dim ForderungsrechnungPointer As Integer



    Dim DebtorBill As New List(Of Debtor)
    ...
    Private Sub ForderungsrechnungToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ForderungsrechnungToolStripMenuItem.Click
        ...
        For i = 0 To 50
            ...
            If PersonID <> "" Then
                ...
                For j = 0 To 19
                    ...
                    Tresenrechnung(TresenrechnungPointer, 0) = PersonID
                    Tresenrechnung(TresenrechnungPointer, 1) = j
                    TresenrechnungPointer += 1
        ...
        For i = 0 To 1000
            ListView6.Items.Add(Tresenrechnung(i, 0))
            ListView6.Items(i).SubItems.Add(Tresenrechnung(i, 1))
        Next
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        For i = 0 To 50
            ...
            For j = 0 To 19
                ...
                DebtorBill.Add(New Debtor(Person(i, 0), Person(i, 1), j))
        ...
        For Each NDeb As Debtor In DebtorBill
            Dim count As Integer

            ListView6.Items.Add(NDeb.Output(0))
            ListView6.Items(count).SubItems.Add(NDeb.Output(1))
            ListView6.Items(count).SubItems.Add(NDeb.Output(2))
            ListView6.Items(count).SubItems.Add(NDeb.Output(3))
            ListView6.Items(count).SubItems.Add(NDeb.Output(4))
            ListView6.Items(count).SubItems.Add(NDeb.Output(5))
            ListView6.Items(count).SubItems.Add(NDeb.Output(6))
            ListView6.Items(count).SubItems.Add(NDeb.Output(7))
            ListView6.Items(count).SubItems.Add(NDeb.Output(8))
            ListView6.Items(count).SubItems.Add(NDeb.Output(9))
            ListView6.Items(count).SubItems.Add(NDeb.Output(10))
            ListView6.Items(count).SubItems.Add(NDeb.Output(11))
            ListView6.Items(count).SubItems.Add(NDeb.Output(12))
            ListView6.Items(count).SubItems.Add(NDeb.Output(13))
            ListView6.Items(count).SubItems.Add(NDeb.Output(14))
            ListView6.Items(count).SubItems.Add(NDeb.Output(15))
            count += 1
        Next
